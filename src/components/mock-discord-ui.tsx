        ...
        <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
            ...
            <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
                <div className="px-4 h-16 border-b border-[#202225] flex items-center shadow-sm">
                    <div className="w-full bg-[#202225] text-sm rounded px-2 h-8 flex items-center justify-center text-gray-50 cursor-not-allowed">
                ...
                <div className="p-2 bg-[#292b2f] flex items-center">
                    ...
                    <div className="flex items-center space-x-2">
                        <Mic className="size-5 hover:text-white cursor-pointer text-[#b9bbbe]" />
                        <Headphones className="size-5 hover:text-white cursor-pointer text-[#b9bbbe]" />
                        <Cog className="size-5 hover:text-white cursor-pointer text-[#b9bbbe]" />
                    </div>
                </div>
            </div>
            {/* main content */}
            <div className="flex-1 flex flex-col">
                ...
                <div className="p-4">
                    <div className="flex items-center bg-[#40444b] rounded-lg p-1">
                        ...
                        <input type="text" readOnly placeholder="Message @PingPanda" className="flex-1 bg-transparent py-2.5 px-1 text-white placeholder-[#72767d] focus:outline-none cursor-not-allowed" />
