            ...
            <MaxWidthWrapper>
                <div className="mx-auto max-w-2xl sm:text-center">
                    ...
                    <p className="mt-6 text-base/7 text-gray-600 max-w-prose text-center text-pretty">
                        We hate subscriptions. And chances are you do too. That's why we offer liftime access to PingPanda for a one-time payment.
                    </p>
                </div>
                <div className="bg-white mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                    <div className="p-8 sm:p-10 lg:flex-auto">
                        ...
                        <p className="mt-6 text-base/7 text-gray-600">
                            Invest one in PingPanda and transform how you monitor your SaaS forever. Get instant alerts, track critical metrics and never miss a beat in your business.
                        </p>
                        ...
                        <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                            <div className="mx-auto max-w-xs px-8">
                                ...
                                <p className="mt-6 flex items-baseline justify-center gap-x-2">
                                    ...
                                    <span className="text-sm font-semibold leadin6 tracking-wide text-gray-600">
                                        INR
                                    </span>
                                </p>
                                <Button
