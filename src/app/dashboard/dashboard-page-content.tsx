...
export const DashboardPageContent = () => {
    ...
    const [deletetingCategory, setDeletingCategory] = useState<string | null>(null);
            ...
            >
                <div className="space-y-6">
                    <div>
                        ...
                        <p className="text-sm/6 text-gray-600">
                            Are your sure you want to delete the category "{deletetingCategory}" ? This action cannot be undone.
                        </p>
                    </div>
                    <div className="flex justify-end space-x-3 pt-4 border-t">
                        ...
                        <Button
                            variant='destructive'
                            onClick={() => deletetingCategory && deleteCategory(deletetingCategory)}
